                  ...
                  SliverList(
                    ...
                    (context, index) => Padding(
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          title: Text(
                              snapshot.data.data['students'][index]['name'],
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                              )),
                          //title: Text('# $index'),
...
/* class MarksController {
  final TextEditingController marksObtained;

  MarksController(this.marksObtained);
} */
...
/*   final List<MarksController> marksControllers = List<MarksController>(); */
